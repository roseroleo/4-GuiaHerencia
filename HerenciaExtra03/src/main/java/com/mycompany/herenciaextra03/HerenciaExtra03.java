 ...
 */
package com.mycompany.herenciaextra03;
...
public class HerenciaExtra03 {
    ...
    public static void main(String[] args) {
        ...
        int opc;
        do {
            System.out.println("**** SERVICIO DE SONSULTA DE ALOJAMIENTOS ****");
            System.out.println("1 Consultar todos los alojamientos disponibles");
            System.out.println("2 Odenar hoteles por precio");
            System.out.println("3 Consultar todos los camping con restaurante");
            System.out.println("4 Consultar residencias con descuento");
